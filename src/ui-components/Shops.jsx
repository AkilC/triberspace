...
export default function Shops(props) {
  ...
  return (
    <Flex
      ...
      {...getOverrideProps(overrides, "Shops")}
      {...rest}
    >
      <Flex
        width="unset"
        ...
        >
          ...
          >
            <Flex
              width="unset"
              height="unset"
              {...getOverrideProps(overrides, "Cards38582033")}
            ></Flex>
            <Flex
              width="unset"
              height="unset"
              {...getOverrideProps(overrides, "Cards38582034")}
            ></Flex>
            <Flex
              width="unset"
              height="unset"
              {...getOverrideProps(overrides, "Cards38582035")}
            ></Flex>
            <Flex
              width="unset"
              height="unset"
              {...getOverrideProps(overrides, "Cards38582036")}
            ></Flex>
            <Flex
              width="unset"
              height="unset"
              {...getOverrideProps(overrides, "Cards38582037")}
            ></Flex>
            <Flex
              width="unset"
              height="unset"
              {...getOverrideProps(overrides, "Cards38582038")}
            ></Flex>
            <Flex
              width="unset"
              height="unset"
              {...getOverrideProps(overrides, "Cards38582039")}
            ></Flex>
            <Flex
              width="unset"
              height="unset"
              {...getOverrideProps(overrides, "Cards38582040")}
            ></Flex>
          </Flex>
        </Flex>
        <Flex
