...
import { listEvents, listWorlds } from "../graphql/queries";
import { createSpace, updateEvent } from "../graphql/mutations";
...
export default function SpaceCreateForm(props) {
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          const modelFieldsToSave = {
            ...
            wID: modelFields?.World?.id,
          };
          const space = (
            await client.graphql({
              query: createSpace.replaceAll("__typename", ""),
              variables: {
                input: {
                  ...modelFieldsToSave,
                },
      ...
      {...getOverrideProps(overrides, "SpaceCreateForm")}
      {...rest}
    >
      <TextField
        label="Title"
