        ...
        >
          ...
          >
            <Text
              ...
              {...getOverrideProps(overrides, "Edit Settings")}
            ></Text>
          </Flex>
        </Flex>
        <Flex
        ...
        >
          ...
          >
            ...
            <Text
              ...
              whiteSpace="pre-wrap"
              children="@username"
              {...getOverrideProps(overrides, "@username38582148")}
            ></Text>
            <Text
              fontFamily="Work Sans"
              fontSize="16px"
            ...
            >
              ...
              >
                ...
                <Text
                  ...
                  whiteSpace="pre-wrap"
                  children="Tribes"
                  {...getOverrideProps(overrides, "Tribes")}
                ></Text>
              </Flex>
              <Flex
                gap="4px"
            ...
            >
              ...
              >
                ...
                <Flex
                  ...
                  borderRadius="12px"
                  padding="9px 9px 9px 9px"
                  {...getOverrideProps(overrides, "UsernameField38582166")}
                >
                  <Text
                    fontFamily="Inter"
                    fontSize="16px"
                    ...
                    whiteSpace="pre-wrap"
                    children="@username"
                    {...getOverrideProps(overrides, "@username38582167")}
                  ></Text>
                </Flex>
              </Flex>
              <Flex
              ...
              >
                ...
                <Flex
                  ...
                  borderRadius="12px"
                  padding="9px 9px 9px 9px"
                  {...getOverrideProps(overrides, "UsernameField38582170")}
                >
                  <Text
                    fontFamily="Inter"
                    fontSize="16px"
                    ...
                    whiteSpace="pre-wrap"
                    children="@username"
                    {...getOverrideProps(overrides, "@username38582171")}
                  ></Text>
                </Flex>
              </Flex>
              <Flex
              ...
              >
                ...
                <Flex
                  ...
                  borderRadius="12px"
                  padding="9px 9px 9px 9px"
                  {...getOverrideProps(overrides, "UsernameField38582174")}
                >
                  <Text
                    fontFamily="Inter"
                    fontSize="16px"
                    ...
                    whiteSpace="pre-wrap"
                    children="@username"
                    {...getOverrideProps(overrides, "@username38582175")}
                  ></Text>
                </Flex>
              </Flex>
            </Flex>
